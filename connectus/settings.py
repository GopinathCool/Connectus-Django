...
SECRET_KEY = '$80go1d0n1zo2zqk-r3woydq@+2cafa@v*t!=s_#)m#6qh+lbo'
...
INSTALLED_APPS = [
    ...
    'django.contrib.sites',  # Added newly
    'login'
]
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.media'  # Include this, to use MEDIA_URL tag in template
            ],
        },
    },
]
...
EMAIL_HOST_PASSWORD = 'gopigopi007'
EMAIL_PORT = 25
EMAIL_USE_TLS = True
